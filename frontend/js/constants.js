const contractAddress = "0x062B4498fd603B797c59a369C5b930461Eb53ca0"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the The After Life Club!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The After Life Club is a skull collection of 10,000 NFTs and is a venture of an experience where you can feel what life after death is. Your afterlife skull gives you access to exclusive benefits such as adventures where members can travel through time and experience life after death.';
const h1_presale_coming_soon = "The After Life Club Coming Soon!!";
...
const p_presale_mint_already_minted = "Welcome to The After Life Club! 🎉";
